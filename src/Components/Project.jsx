...
const projects = [
  {
    ...
    description:
      "A fully responsive e-commerce platform built with React, JWT, React Router, and more.",
    tech: ["React", "JWT", "React Router", "tailwindcss", "JavaScript"],
    image: freshCartImg,
    demo: "https://fresh-cart-gilt-eta.vercel.app/",
  ...
  },
  {
    ...
    image: yummyImg,
    demo: "https://osamamahros50.github.io/Yommy/",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, index) => (
            ...
            >
              {/* Image */}
              <div
                className="relative group h-[200px] sm:h-[220px] lg:h-[240px] overflow-hidden rounded-lg cursor-pointer"
